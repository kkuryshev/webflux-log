...
public class ClientResponseLoggingFilterComponentTest extends BaseMockServerTest {
    ...
    void logResponse_whenReqIdParamIsTrue_thenLog(LoggingProperties loggingProperties) {
        ...
        WireMock.stubFor(WireMock.post(PATH).willReturn(WireMock.status(200).withFixedDelay(65)));
    ...
    void logResponse_whenHeadersOrCookiesAreTrue_thenLog(LoggingProperties loggingProperties) {
        ...
        ResponseCookie responseCookie0 =
                ResponseCookie.from("Cookie-1", "value1")
                        .maxAge(Duration.ofSeconds(1000))
                        .domain("some.domain")
                        .httpOnly(true)
                        .build();

        ResponseCookie responseCookie1 =
                ResponseCookie.from("Cookie-2", "value2")
                        .secure(true)
                        .domain("other.domain")
                        .httpOnly(false)
                        .build();
