...
public class CookieProviderUnitTest extends BaseTest {
    ...
    private final LoggingProperties propsNoMasked =
            LoggingProperties.builder().logCookies(true).build();
    ...
    void createClientRequestMessage_whenMasked_thenAddWithMask() {
        ...
        LoggingProperties propsWithMasked =
                ...
                () ->
                        assertEquals(
                                ...
                                StringUtils.countMatches(
                                        actual, cookieName0 + "=" + LoggingUtils.DEFAULT_MASK)),
    ...
    void createServerRequestMessage_whenNoMasked_thenAddAll(
            HttpCookie cookie0,
            HttpCookie cookie1,
            HttpCookie cookie2,
            HttpCookie cookie3,
    ...
    @ParameterizedTest
    @MethodSource("getHttpCookies")
    void createServerRequestMessage_whenMasked_thenAddWithMask(
            HttpCookie cookie0,
            HttpCookie cookie1,
            HttpCookie cookie2,
            HttpCookie cookie3,
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                ...
                                StringUtils.countMatches(
                                        actual,
                                        cookie0.getName() + "=" + LoggingUtils.DEFAULT_MASK)),
                () -> assertFalse(actual.contains(cookie1.toString())),
                () ->
                        assertTrue(
                                actual.contains(
                                        cookie1.getName() + "=" + LoggingUtils.DEFAULT_MASK)),
                () -> assertFalse(actual.contains(cookie2.toString())),
                () ->
                        assertTrue(
                                actual.contains(
                                        cookie2.getName() + "=" + LoggingUtils.DEFAULT_MASK)),
                () -> assertTrue(actual.contains(cookie3.toString())),
                () -> assertFalse(actual.contains(notExistingCookieName)));
    }
    ...
    void createResponseMessage_whenNoMasked_thenAddAll(
            ResponseCookie cookie0,
            ResponseCookie cookie1,
            ResponseCookie cookie2,
            ResponseCookie cookie3,
    ...
    @ParameterizedTest
    @MethodSource("getResponseCookies")
    void createResponseMessage_whenMasked_thenAddWithMask(
            ResponseCookie cookie0,
            ResponseCookie cookie1,
            ResponseCookie cookie2,
            ResponseCookie cookie3,
    ...
    private static Stream<Arguments> getResponseCookies() {
        ResponseCookie cookie0 =
                ResponseCookie.from(RandomString.make(), RandomString.make())
                        .httpOnly(true)
                        .secure(true)
                        .build();
        ...
        ResponseCookie cookie1 =
                ResponseCookie.from(RandomString.make(), RandomString.make())
                        .httpOnly(false)
                        .domain(RandomString.make())
                        .build();

        ResponseCookie cookie2 =
                ResponseCookie.from(cookie0.getName(), RandomString.make())
                        .httpOnly(true)
                        .sameSite(RandomString.make())
                        .build();
